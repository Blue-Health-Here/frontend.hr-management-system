  ...
  return (
    <div>
      <div className="flex flex-wrap gap-4 items-center justify-between pb-6">
        <h1 className="text-xl md:text-2xl font-semibold text-gray-900">Payslip</h1>
        <div className="flex items-center gap-3">
          <Button label='Download' icon={Download} />
        </div>
      </div>
      <div className="bg-white p-6 rounded-2xl space-y-4 theme-shadow">
        <div className="flex flex-col sm:flex-row gap-4 justify-between items-start pb-4 border-b border-gray-200">
          <div className="space-y-1">
            <h1 className="text-green-600 text-xl md:text-2xl lg:text-3xl font-bold">SmartHR</h1>
            <div className="text-sm text-gray-600">
              3099 Kennedy Court Framingham, MA 01702
            </div>
          </div>
          <div className="sm:text-right text-sm text-gray-500 font-bold space-y-1">
        ...
        <div className="text-center">
          <h2 className="text-base md:text-lg font-semibold text-gray-800">Payslip for the moth of October 2024</h2>
        </div>
