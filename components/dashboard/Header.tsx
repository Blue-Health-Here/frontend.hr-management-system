...
export function DashboardHeader({ user }: DashboardHeaderProps) {
  const ActionButton = ({ text, bgColor, hoverColor }: ActionButtonProps) => (
    <button
      className={`inline-flex items-center gap-2 rounded-md ${bgColor} ${hoverColor} px-3 md:px-4 py-1.5 md:py-2 text-xs md:text-sm font-medium text-white shadow-sm focus:outline-none whitespace-nowrap`}
    >
