      ...
      <nav className="flex flex-col gap-2 flex-1 py-8 px-6">
        {sidebarItems.map((item, index) => {
          ...
          return (
            <div key={index}>
              <div
                className={`flex items-center justify-between px-3 py-2 cursor-pointer rounded-md transition-all duration-200 ${
                  shouldHighlight
                  ...
                  {item.subItems?.map((subItem, subIndex) => {
                    ...
                    return (
                      <Link
                        ...
                        className={`flex items-center py-2 pl-2 text-sm rounded-md relative transition-colors duration-150 ${
