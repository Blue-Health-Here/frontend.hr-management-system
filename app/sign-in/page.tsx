...
export default function SigninPage() {
  ...
  return (
    <AuthLayout>
      <div className="w-full md:w-3/5 lg:w-3/5 flex flex-col justify-center items-center p-8 overflow-y-auto bg-[#f3ebe1] min-h-screen">
        <div className="w-full max-w-[480px] space-y-6">
          ...
          <div>
            <h2 className="text-2xl font-semibold mt-10 text-center">Sign In</h2>

            <div className="text-sm text-gray-500 space-y-4 pt-1">
                  ...
                  <Form className="space-y-4">
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <Link
                        ...
                        className="text-sm text-[#e70d0d] hover:underline"
                      >
                        Forgot password?
                      </Link>
                    </div>
